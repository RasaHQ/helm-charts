...
![Version: 1.17.4](https://img.shields.io/badge/Version-1.17.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.4.4](https://img.shields.io/badge/AppVersion-3.4.4-informational?style=flat-square)
...
| image.tag | string | `"3.4.4"` | Rasa Open Source image tag to use |
