...
![Version: 1.17.6](https://img.shields.io/badge/Version-1.17.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.5.4](https://img.shields.io/badge/AppVersion-3.5.4-informational?style=flat-square)
...
| image.tag | string | `"3.5.4"` | Rasa Open Source image tag to use |
