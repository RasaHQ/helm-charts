...
![Version: 1.1.4](https://img.shields.io/badge/Version-1.1.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.2.0.2-r1](https://img.shields.io/badge/AppVersion-0.2.0.2--r1-informational?style=flat-square)
...
| image.tag | string | `"0.2.0.2-r1"` | Duckling image tag to use |
