...
![Version: 1.1.2](https://img.shields.io/badge/Version-1.1.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.1.6.5-r4](https://img.shields.io/badge/AppVersion-0.1.6.5--r4-informational?style=flat-square)
...
| image.tag | string | `"0.1.6.5-r4"` | Duckling image tag to use |
